...
export default async function Home() {
  ...
  return <div className={`dashboardPageWrap plan-${planId} ${starter ? "starterPlan" : "premiumPlan"}`}>
    ...
    <nav className="dashboardSideExtras" aria-label="Cuenta y soporte"><Link href="/mi-plan"><span>◇</span><b>Planes</b></Link><Link href="/creadores"><span>✦</span><b>Creator Viral</b></Link><Link href="/ayuda"><span>?</span><b>Preguntas frecuentes</b></Link><Link href="/soporte"><span>↗</span><b>Soporte 24/7</b></Link><CreditBadge /></nav>
