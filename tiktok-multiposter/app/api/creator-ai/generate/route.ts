...
export async function POST(req:Request){
 ...
 try{
  ...
  const body=await req.json();const logo=typeof body.logo==="string"&&body.logo.startsWith("data:image/")?body.logo:"";const count=Math.min(7,Math.max(1,Number(body.count)||6));const single=!!body.slide;
