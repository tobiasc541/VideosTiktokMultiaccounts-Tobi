    ...
    <main className="vyralAuthPage">
      <section className="vyralAuthShell">
        <aside className="vyralAuthAside">
          ...
          <div className="vyralAuthSteps"><span>01 Creá tu cuenta</span><span className="active">02 Verificá tu cuenta</span><span>03 Seleccioná tu plan</span><span>04 Disfrutá de la viralidad</span></div>
        </aside>
        <div className="vyralAuthCard">
          ...
          <p className="vyralAuthFine" style={{marginTop:18}}>Si no lo ves, revisá Spam o Correo no deseado.</p>
        </div>
      </section>
    </main>
  );
